SYSTEM_PROMPT = (
    ...
    "TOOL USAGE GUIDE:\n"
    "1. Use 'knowledge_base_search' ONLY IF the question is about the Telecommunication "
    ...
    "'knowledge_base_search' returns no relevant results for a company-specific question.\n\n"
